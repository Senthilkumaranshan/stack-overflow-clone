    ...
    <div>
        <Header />
            ...
            <div class="card-right">
                <div class="card-title fw-7 specific-q">How to use filter in spring cloud data flow?</div>
                <div class="card-text fw-5">I would like to add a filter in spring cloud data flow (SCDF) to debug and see how it works when recieving <br>
                some request I have tried to implements servlet filter and override method...</div>
            </div>
        </div>
    </div>
</template>
...
.card .card-right .card-title {font-size: 20px;color: #00ABF0;text-align: left;}
.card .card-right .card-text {font-size: 14px;color: #000;margin-top: 20px; text-align:left;}
